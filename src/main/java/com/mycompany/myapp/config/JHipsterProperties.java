...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "secondtry@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "secondtry API";

        private String description = "secondtry API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "secondtry";
